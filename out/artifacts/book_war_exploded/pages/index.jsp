...
<body>
    ...
    <!--======= HOME MAIN SLIDER =========-->
    <section class="sub-bnr3 sub-other" data-stellar-background-ratio="0.5">
        <div class="position-center-center">
          <div class="container">
            ...
            <section class="facts parallax-bg padding-top-150 padding-bottom-150" data-stellar-background-ratio="0.5">
                <div class="container">
                    ...
                    <div class="row">
                        <!-- Team Member -->
                        <div class="col-md-4">
                            <div class="facts-magin-left">
                                <img src="img/icon-m.png" alt="">
                                <div class="border-bord"></div>
                                <div>文字文字文字文字</div>
                            </div>
                        </div>
            ...
            <section class="scale">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 scale-items">
                            <img src="img/scale-item1.jpg" alt="">
                            <div class="scale-text scale-bottom">
                                <h5>
                                    123456文字文字文字文字
                                </h5>
                        ...
                        <div class="col-md-4 scale-items">
                            <img src="img/scale-item2.jpg" alt="">
                            <div class="scale-text scale-bottom">
                                <h5>
                                    123456文字文字文字文字
                                </h5>
                        ...
                        <div class="col-md-4 scale-items">
                            <img src="img/scale-item3.jpg" alt="">
                            <div class="scale-text scale-bottom">
                                <h5>
                                    123456文字文字文字文字
                                </h5>
                ...
                <div class="container">
                    ...
                    <div class="heading text-center">
                        <h4 class="facts-title">
                            ...
                            <div class="facts-text">123456文字文字文字文字</div>
                            <div class="facts-border">
                                <div class="border-short"></div>
                                <div class="border-long"></div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="article">
                                <img src="img/icon-xin.png" alt="">
                                <div>123456文字文字文字文字</div>
                                <div>123456文字文字文字文字</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="article">
                                <img src="img/icon-beizi.png" alt="">
                                <div>123456文字文字文字文字</div>
                                <div>123456文字文字文字文字</div>
                            </div>
                        </div>
